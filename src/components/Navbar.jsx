        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-4 text-[13.5px] font-semibold">
            ...
            {session ? (
              ...
              <>
                {/* User Info */}
                <div className="flex items-center gap-2 bg-slate-50 border border-slate-200 rounded-full px-2 py-1.5">
                  ...
                  {session?.user?.image ? (
                    ...
                    <div className="w-9 h-9 rounded-full bg-gradient-to-r from-cyan-500 to-emerald-500 flex items-center justify-center text-white font-bold uppercase border border-slate-200">
                  ...
                  <div className="flex flex-col leading-tight">
                    ...
                    <span className="text-slate-700 font-bold text-sm max-w-[120px] truncate">
                ...
                <motion.button
                  ...
                  className="bg-gradient-to-r from-red-500 to-rose-500 hover:from-red-600 hover:to-rose-600 text-white font-bold px-4 py-2 rounded-full transition-all duration-300 shadow-sm text-xs"
                >
        ...
        <AnimatePresence>
          ...
          {isOpen && (
            ...
            >
              ...
              {/* Mobile Buttons */}
              <div className="pt-3 px-4 pb-4 border-t border-slate-100/60">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center gap-3 bg-slate-50 rounded-2xl p-3 border border-slate-200">
                      ...
                      {session?.user?.image ? (
                        ...
                        <div className="w-11 h-11 rounded-full bg-gradient-to-r from-cyan-500 to-emerald-500 flex items-center justify-center text-white font-bold text-lg uppercase">
                    ...
                    <button
                      ...
                      className="w-full py-3 rounded-xl bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-white font-bold transition-all duration-300 shadow-sm"
                    >
